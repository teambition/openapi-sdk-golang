...
func (o *CreateGroupResponse) GetResult() SearchGroupsResponseResultInner {
...
func (o *CreateGroupResponse) GetResultOk() (*SearchGroupsResponseResultInner, bool) {
	if o == nil || IsNil(o.Result) {
		return nil, false
	}
...
func (o *CreateGroupResponse) HasResult() bool {
	if o != nil && !IsNil(o.Result) {
		return true
	}
...
func (o *CreateGroupResponse) SetResult(v SearchGroupsResponseResultInner) {
	o.Result = &v
}

// GetCode returns the Code field value if set, zero value otherwise.
func (o *CreateGroupResponse) GetCode() float32 {
...
// and a boolean to check if the value has been set.
func (o *CreateGroupResponse) GetCodeOk() (*float32, bool) {
	if o == nil || IsNil(o.Code) {
		return nil, false
	}
	return o.Code, true
...
func (o *CreateGroupResponse) SetCode(v float32) {
	o.Code = &v
}

// GetErrorMessage returns the ErrorMessage field value if set, zero value otherwise.
func (o *CreateGroupResponse) GetErrorMessage() string {
...
// and a boolean to check if the value has been set.
func (o *CreateGroupResponse) GetErrorMessageOk() (*string, bool) {
	if o == nil || IsNil(o.ErrorMessage) {
		return nil, false
	}
...
func (o *CreateGroupResponse) HasErrorMessage() bool {
	if o != nil && !IsNil(o.ErrorMessage) {
		return true
	}
...
func (o *CreateGroupResponse) SetErrorMessage(v string) {
	o.ErrorMessage = &v
}

// GetRequestId returns the RequestId field value if set, zero value otherwise.
func (o *CreateGroupResponse) GetRequestId() string {
...
// and a boolean to check if the value has been set.
func (o *CreateGroupResponse) GetRequestIdOk() (*string, bool) {
	if o == nil || IsNil(o.RequestId) {
		return nil, false
	}
...
func (o *CreateGroupResponse) HasRequestId() bool {
	if o != nil && !IsNil(o.RequestId) {
		return true
	}
...
func (o *CreateGroupResponse) SetRequestId(v string) {
	o.RequestId = &v
}
